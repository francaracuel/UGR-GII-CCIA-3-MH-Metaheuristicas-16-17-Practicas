...
public:
    ...
    //
    pair<vector<float>, float> localSearch();
    
    pair<vector<float>, float> localSearch(unsigned int& numEval);
    
    pair<vector<float>, float> localSearch(const vector<float>& w, unsigned int& numEval);
