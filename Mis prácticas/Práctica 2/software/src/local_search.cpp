...
//
pair<vector<float>, eval> LocalSearch::localSearch(){
...
pair<vector<float>, eval> LocalSearch::localSearch(const vector<float>& w, 
...
pair<vector<float>, eval> LocalSearch::localSearch(Sorter s, 
...
pair<vector<float>, eval> LocalSearch::localSearch(unsigned int& numEvalP){
    ...
    //while(iEval < numEval && iNeig < numNeig){
        ...
        // Vector de pesos que se va a mutar con la mejor solución hasta ahora
        vector<float> wNew = w;
    ...
    return pair<vector<float>, eval>(w, pF);
